...
public class EffectDefinition {
    public enum ProficiencyImpact { DURATION, COOLDOWN, DICE_MULTIPLIER, TICKS_REMAINING }
    public enum Type { MODIFIER, HEAL, DOT, CUSTOM, INSTANT_HEAL, INSTANT_DAMAGE, WEAPON_INFUSION, WEAPON_COATING, DEBUFF, BURNING_HANDS, CALL_LIGHTNING, CAUSE_WOUNDS, DRAIN_LIFE, CORPSE_EXPLOSION, BONE_ARMOR, PLAGUE, DEATH_COIL, DEATH_COIL_DOT, METEOR_SWARM, UNDEAD, SLOW, CONFUSED, PARALYZED, CURSED, FLYING, HASTE, DIVINE_INTERVENTION, REGEN_HOT, AURA_REGEN_HOT, SANCTUARY_AURA, PROTECTION_AURA, AURA_MODIFIER, HOLY_AVENGER, BESTIAL_WRATH }
