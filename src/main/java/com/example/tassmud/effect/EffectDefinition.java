...
public class EffectDefinition {
    ...
    public enum Type { MODIFIER, HEAL, DOT, CUSTOM, INSTANT_HEAL, INSTANT_DAMAGE, WEAPON_INFUSION, DEBUFF, BURNING_HANDS, CALL_LIGHTNING, CAUSE_WOUNDS, UNDEAD, SLOW, CONFUSED, PARALYZED, CURSED, FLYING, HASTE }
